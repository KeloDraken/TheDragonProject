    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', core.accounts.models.LowercaseCharField(error_messages={'unique': 'This username is not available, please try another one.'}, help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=300, unique=True, validators=[core.accounts.validators.UnicodeEmailValidator()], verbose_name='username')),
