...
const Tags = (): JSX.Element => {
  ...
  const handleTagFetch = (): void => {
    const endpoint: string = `${process.env.REACT_APP_API_HOST_NAME}/v1/tags/list/?page=1`;
  ...
  const handleFetchMore = (): void => {
    setLoadingMore(true);
    const endpoint: string = `${process.env.REACT_APP_API_HOST_NAME}/v1/tags/list/?page=${start}`;
