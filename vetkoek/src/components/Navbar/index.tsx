...
const Navbar = () => {
    return (
        <View>
            <Logo />
            <Link to="/" className="flex mt-7 pl-3 py-3 navlink">
            ...
            <Link to="/account" className="flex px-3 py-3 navlink">
                <i className="material-icons-outlined pl-3 text-black">account_circle</i>
                <span className="hidden md:block lg:block xl:block 2xl:block">
                    <Text style={styles.navLinkText}>Profile</Text>
                </span>
            </Link>
            <Link to="/about" className="flex px-3 py-3 navlink">
