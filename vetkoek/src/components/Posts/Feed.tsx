...
const Feed = (): JSX.Element => {
  ...
  const handlePostFetch = (): void => {
    const endpoint: string = `${process.env.REACT_APP_API_HOST_NAME}/v1/posts/list/?page=1`;
  ...
  const handleFetchMore = (): void => {
    ...
    const endpoint: string = `${process.env.REACT_APP_API_HOST_NAME}/v1/posts/list/?page=${start}`;
